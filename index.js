...
const vcard = 'BEGIN:VCARD\n' //jangan ganti!
            + 'VERSION:3.0\n' //jangan ganti!
            + 'FN:R y u g a S a k i\n' //ganti nama lu! 
            + 'ORG: X-BOT V1;\n' //ganti nama bot lu!
            + 'TEL;type=CELL;type=VOICE;waid=6282293271747:+628229327174\n'  //ganti nomor lu! 
            + 'END:VCARD' //jangan ganti
const vcard1 = 'BEGIN:VCARD\n' //jangan ganti!
             + 'VERSION:3.0\n' //jangan ganti!
             + 'FN:RZ STORE\n' //ganti nama lu! 
             + 'ORG: X-BOT V1;\n' //ganti nama bot lu!
             + 'TEL;type=CELL;type=VOICE;waid=6282210297009:+6282210297009\n'  //ganti nomor lu! 
             + 'END:VCARD' //jangan ganti
prefix = '!' //terserah mau ganti tao ga
blocked = [] //biarin
limitawal = 20 //terserah mau ganti tao ga
memberlimit = 1 //terserah mau ganti tao ga
namabot = 'X-BOT V1'
cr = '*「 X-BOT V1 」*' //ganti nama bot
lolkey = 'e3d6805ea05cefd5b8fc3a9c' //apiknya
/******** OWNER NUMBER**********/

const ownerNumber = ["6282293271747@s.whatsapp.net", "6282210297009@s.whatsapp.net"]   //ganti nomor lu! 
...
const client = new WAConnection()
   ...
   console.log(color('[','white'),color('∆','red'),color(']','white'),color('QR code is ready, Scan now..','white'),color('GUSTIGANZツ','red'),color('X','lime'),color('LoL-Human','red'))
})
...
case 'addbadword':
		...
		case 'grouplist':
                 ...
                 if (!isRegistered) return reply( ind.noregis())
					client.updatePresence(from, Presence.composing) 
					teks = `\`\`\`Ini adalah list group X-BOT V1 :\n\n\`\`\``
					no = 0
...
` 
client.sendMessage(from, wew, image, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "caption": "*X-BOT V1 VERIFIED*", "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('src/logobot.jpg')} } }, caption: zain, pushname, prefix, getLevelingXp, getLevelingLevel, sender, role })
client.sendMessage(from, loli, MessageType.audio, {qouted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'groupmenu':
if (isBanned) return reply('Maaf kamu sudah terbenned!')
wew = fs.readFileSync(`./src/logobot.jpg`)
...
break
		...
		case 'lpr':
					...
					client.sendMessage('6282293271747@s.whatsapp.net', options, text, {quoted: mek})
					reply('Masalah telah di laporkan ke owner X-BOT V1 Laporan palsu atau main² tidak akan ditanggapi.')
					break
					case 'antidelete':
		...
		case 'request':
					...
					client.sendMessage('6282293271747@s.whatsapp.net', options, text, {quoted: mek})
					reply('REQUEST ANDA TELAH SAMPAI KE OWNER X-BOT V1 REQUESTS PALSU ATAU MAIN² TIDAK AKAN DITANGGAPI.')
					break
		case 'blocklist': 
...
if (args.length == 0) return reply(`Idnya mana kak?`)
                    ff_id = args[0]
                    get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/freefire/${ff_id}?apikey=e472d35a2739cdb65bdd7bc4`)
		...
		case 'group':
            ...
            case 'developer':
                 ...
                 client.sendMessage(from, '*_ɪᴛᴜ ᴘᴀᴄᴀʀᴋᴜ ᴇʜ ᴍᴀᴋꜱᴜᴅɴʏᴀ ᴏᴡɴᴇʀᴋᴜ >-<_*',MessageType.text, { quoted: mek} )
                 break
           case 'setname':
					if (!isGroup) return reply(ind.groupo())
					if (isBanned) return reply('Maaf kamu sudah terbenned!')
...
case 'waifu':
if (isBanned) return reply('Maaf kamu sudah terbe nned!')
if (!isRegistered) return reply( ind.noregis()) 
reply(ind.wait())
waifu = await getBuffer(`https://api.lolhuman.xyz/api/random/waifu?apikey=e472d35a2739cdb65bdd7bc4`)
...
if (!isRegistered) return reply( ind.noregis()) 
reply(ind.wait())
husbu = await getBuffer(`https://api.lolhuman.xyz/api/random/husbu?apikey=e472d35a2739cdb65bdd7bc4`)
...
if (!isRegistered) return reply( ind.noregis()) 
reply(ind.pedo())
loli = await getBuffer(`https://api.lolhuman.xyz/api/random/loli?apikey=e472d35a2739cdb65bdd7bc4`)
...
if (!isRegistered) return reply( ind.noregis()) 
reply(ind.wait())
elf = await getBuffer(`https://api.lolhuman.xyz/api/random/elf?apikey=e472d35a2739cdb65bdd7bc4`)
...
//MAKERMENU
		...
		if (isBanned) return reply('Maaf kamu sudah terbenned!')
                    ...
                    ini_txt = args.join(" ")
                    ini_buffer = await getBuffer(`http://api.lolhuman.xyz/api/textprome/${command}?apikey=e472d35a2739cdb65bdd7bc4&text=${ini_txt}`)
		...
		if (isBanned) return reply('Maaf kamu sudah terbenned!')
               cf = `${body.slice(8)}`
                    ...
                    txt1 = args[0]
                    txt2 = args[1]
                    ini_buffer = await getBuffer(`http://api.lolhuman.xyz/api/textprome2/${command}?apikey=e472d35a2739cdb65bdd7bc4&text1=${txt1}&text2=${txt2}`)
		...
		if (isBanned) return reply('Maaf kamu sudah terbenned!')
                    if (args.length == 0) return reply(`Example: ${prefix + command} Its Ara`)
                    ini_txt = args.join(" ")
                    ini_buffer = await getBuffer(`http://api.lolhuman.xyz/api/photooxy1/${command}?=e472d35a2739cdb65bdd7bc4&text=${ini_txt}`)
                    client.sendMessage(from, ini_buffer, image, { quoted: mek})
                    break
                case 'tiktok':
                case 'arcade8bit':
		...
		if (isBanned) return reply('Maaf kamu sudah terbenned!')
                    ...
                    txt1 = args[0]
                    txt2 = args[1]
                    ini_buffer = await getBuffer(`http://api.lolhuman.xyz/api/photooxy2/${command}?=e472d35a2739cdb65bdd7bc4&text1=${txt1}&text2=${txt2}`)
                    client.sendMessage(from, ini_buffer, image, { quoted: mek})
                    break
		...
		if (isBanned) return reply('Maaf kamu sudah terbenned!')
                    if (args.length == 0) return reply(`Example: ${prefix + command} Its Ara`)
                    ini_txt = args.join(" ")
                    ini_buffer = await getBuffer(`http://api.lolhuman.xyz/api/ephoto1/${command}?=e472d35a2739cdb65bdd7bc4&text=${ini_txt}`)
                    client.sendMessage(from, ini_buffer, image, { quoted: mek})
                    break
                case 'githubstalk':
                    if (!isRegistered) return reply(ind.noregis())
                    ...
                    username = args[0]
                    ini_result = await fetchJson(`https://api.lolhuman.xyz/api/github/${username}?apikey=e472d35a2739cdb65bdd7bc4`)
...
//DOWNLOAD MENU
                    ...
                    query = args.join(" ")
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/ytplay?apikey=e472d35a2739cdb65bdd7bc4&query=${query}`)
                    get_result = get_result.result
                    ...
                    if (args.length == 0) return reply(`Example: ${prefix + command} Dj Tie Me Down`)
                    query = args.join(" ")
                    get_result = await fetchJson(`http://api.lolhuman.xyz/api/ytplay2?apikey=e472d35a2739cdb65bdd7bc4&query=${query}`)
                    get_result = get_result.result
                    ...
                    ini_link = args[0]
                    get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/ytaudio2?apikey=e472d35a2739cdb65bdd7bc4&url=${ini_link}`)
                    get_result = get_result.result
                    ...
                    if (args.length == 0) return reply(`Example: ${prefix + command} Dj Tie Me Down`)
                    query = args.join(" ")
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/ytsearch?apikey=e472d35a2739cdb65bdd7bc4&query=${query}`)
                    get_result = get_result.result
                    ini_txt = ""
                    ...
                    if (args.length == 0) return reply(`Example: ${prefix + command} https://www.youtube.com/watch?v=qZIQAk-BUEc`)
                    ini_link = args[0]
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/ytaudio?apikey=e472d35a2739cdb65bdd7bc4&url=${ini_link}`)
                    get_result = get_result.result
                    ...
                    if (args.length == 0) return reply(`Example: ${prefix + command} https://www.youtube.com/watch?v=qZIQAk-BUEc`)
                    ini_link = args[0]
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/ytaudio2?apikey=e472d35a2739cdb65bdd7bc4&url=${ini_link}`)
                    get_result = get_result.result
                    ...
                    if (args.length == 0) return reply(`Example: ${prefix + command} https://www.youtube.com/watch?v=qZIQAk-BUEc`)
                    ini_link = args[0]
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/ytvideo?apikey=e472d35a2739cdb65bdd7bc4&url=${ini_link}`)
                    get_result = get_result.result
                    ini_txt = `Title : ${get_result.title}\n`
                    ini_txt += `Uploader : ${get_result.uploader}\n`
                    ini_txt += `Duration : ${get_result.duration}\n`
                    ...
                    if (args.length == 0) return reply(`Example: ${prefix + command} https://www.youtube.com/watch?v=qZIQAk-BUEc`)
                    ini_link = args[0]
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/ytvideo2?apikey=e472d35a2739cdb65bdd7bc4&url=${ini_link}`)
                    get_result = get_result.result
                    ini_txt = `${get_result.title} - ${get_result.size}`
                    ini_buffer = await getBuffer(get_result.thumbnail)
                    ...
                    if (!isRegistered) return reply(ind.noregis())
                    if (isBanned) return reply('Maaf kamu sudah terbenned!')
                    reply(`*「OPEN JASA SEWA BOT」*


╭───────────────
┊ᴏᴡɴᴇʀ : *MR. KR3M*
┊ʙᴏᴛ : X-BOT V1
┊ᴡᴀ ᴏᴡɴᴇʀ : Wa.me/6282293271747
╰────────────────
         ┊ *Harga Sewa Bot*
         ┊ 1 Hari    : Rp3000
         ┊ 1 Minggu : Rp5000
...
Zimbabwe 263`)
  ...
  ├─ ❏ DONASI SEIKHLASNYA GAN`)
                ...
                if (!isRegistered) return reply(ind.noregis())
                if (isBanned) return reply('Maaf kamu sudah terbenned!')
                sound1 = fs.readFileSync(`./sound/sound1.mp3`)
                client.sendMessage(from, sound1, MessageType.audio, {qouted: mek, mimetype: 'audio/mp4', ptt:true, seconds: 9999999})
                break
                case 'sound2':
                if (!isRegistered) return reply(ind.noregis())
                if (isBanned) return reply('Maaf kamu sudah terbenned!')
                sound2 = fs.readFileSync(`./sound/sound2.mp3`)
                client.sendMessage(from, sound2, MessageType.audio, {qouted: mek, mimetype: 'audio/mp4', ptt:true, seconds: 9999999})
                break
                case 'sound3':
                if (!isRegistered) return reply(ind.noregis())
                if (isBanned) return reply('Maaf kamu sudah terbenned!')
                sound3 = fs.readFileSync(`./sound/sound3.mp3`)
                client.sendMessage(from, sound3, MessageType.audio, {qouted: mek, mimetype: 'audio/mp4', ptt:true, seconds: 9999999})
                break
                case 'sound4':
                if (!isRegistered) return reply(ind.noregis())
                if (isBanned) return reply('Maaf kamu sudah terbenned!')
                sound4 = fs.readFileSync(`./sound/sound4.mp3`)
                client.sendMessage(from, sound4, MessageType.audio, {qouted: mek, mimetype: 'audio/mp4', ptt:true, seconds: 9999999})
                break
                case 'sound5':
                if (!isRegistered) return reply(ind.noregis())
                if (isBanned) return reply('Maaf kamu sudah terbenned!')
                sound5 = fs.readFileSync(`./sound/sound5.mp3`)
                client.sendMessage(from, sound5, MessageType.audio, {qouted: mek, mimetype: 'audio/mp4', ptt:true, seconds: 9999999})
                break
                case 'sound6':
                if (!isRegistered) return reply(ind.noregis())
                if (isBanned) return reply('Maaf kamu sudah terbenned!')
                sound6 = fs.readFileSync(`./sound/sound6.mp3`)
                client.sendMessage(from, sound6, MessageType.audio, {qouted: mek, mimetype: 'audio/mp4', ptt:true, seconds: 9999999})
                break
                case 'sound7':
                if (!isRegistered) return reply(ind.noregis())
                if (isBanned) return reply('Maaf kamu sudah terbenned!')
                sound7 = fs.readFileSync(`./sound/sound7.mp3`)
                client.sendMessage(from, sound7, MessageType.audio, {qouted: mek, mimetype: 'audio/mp4', ptt:true, seconds: 9999999})
                break
                case 'sound8':
                if (!isRegistered) return reply(ind.noregis())
                if (isBanned) return reply('Maaf kamu sudah terbenned!')
                sound8 = fs.readFileSync(`./sound/sound8.mp3`)
                client.sendMessage(from, sound8, MessageType.audio, {qouted: mek, mimetype: 'audio/mp4', ptt:true, seconds: 9999999})
                break
                case 'troli':
                if (!isOwner) return reply(ind.ownerg()) 
                for (let i = 0; i < args[0]; i++) {
                client.sendMessage(from, `Punten !!!`, MessageType.extendedText,{ 
                 quoted: {
                key: {
